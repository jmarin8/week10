...
sub topHit{
	my $seq = shift;
	print "Submitting BLAST (Search $i)..."; $i++;
...
print "\n\tTop Non-self Hit (Second Search)\n",					
...
print "\nNOTE: Top Non-self Hit in Second Search is the same as the original" . 
